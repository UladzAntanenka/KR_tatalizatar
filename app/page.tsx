      ...
      <div className="mx-auto max-w-7xl px-4 py-8 md:py-12">
        <section className="hero-card relative mb-8 overflow-hidden rounded-[2.5rem] p-7 md:p-12">
          ...
          <div className="relative z-10">
            ...
            <p className="body-text max-w-2xl text-[var(--ink-2)] md:text-xl">
              Абярыце 80 дэлегатаў, адзначце спісы якія не пераадолеюць 3% і
        ...
        <section className="mb-8 grid gap-4 md:grid-cols-3">
          ...
          <InfoCard
            ...
            text="Калі лічыце, што спіс не набярэ больш за 3%, пазначце яго."
          />
          <InfoCard
            number="03"
        ...
        <section className="card mt-8 p-6 md:p-8">
          ...
          <p className="body-text mb-5 text-[var(--ink-3)]">
            Ваш прагноз агульнай яўкі ў галасаваннях
          </p>
              ...
              {factionSummary
                ...
                .map((faction) => (
                  <div
                    ...
                    title={`${shortFactionName(faction.faction)}: ${
                      faction.selected
                    }`}
                  />
                ))}
  ...
  return (
    <style jsx global>{`
      ...
      .btn-primary:hover {
        ...
        box-shadow: 0 8px 24px rgba(14, 12, 8, 0.25);
      }
      ...
      .votes-input:focus {
        ...
        box-shadow: 0 0 0 4px rgba(36, 85, 195, 0.12);
      }
      ...
      .submit-btn:hover:not(:disabled) {
        transform: translateY(-1px);
        box-shadow: 0 8px 28px rgba(232, 66, 10, 0.4);
        opacity: 0.92;
      }
